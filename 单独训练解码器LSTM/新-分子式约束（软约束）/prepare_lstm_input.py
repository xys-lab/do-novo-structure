...
# 配置文件路径
# =============================
mlp_csv_path = Path(r"D:\实验\数据\DSSTox_Feb_2024\试验小样本5000\pred_embedding_5000_3万.csv")
ms_csv_path = Path(r"D:\实验\数据\DSSTox_Feb_2024\试验小样本5000\ms_all_features_5000_3万.csv")
canonical_smiles_csv_path = Path(r"D:\实验\数据\DSSTox_Feb_2024\试验小样本5000\provided_with_all_5000_3万.csv")

output_dir = Path(r"D:\实验\数据\DSSTox_Feb_2024\试验小样本5000\lstm_total")
...
# 基础检查
# =============================
required_smiles_cols = ["ID", "canonical_smiles", "formula", "inchikey"]
...
all_df = pd.concat(
    [
        smiles_df[["ID", "canonical_smiles", "formula", "inchikey"]].reset_index(drop=True),
